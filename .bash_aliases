...
alias pyc='pyclean . && ./manage.py clean_pyc'
alias vstapp1='ssh -A waveaccounting@72.51.30.183'
alias vstapp2='ssh -A waveaccounting@72.51.30.143'
alias vstcel1='ssh -A waveaccounting@72.51.30.181'
alias vstcel2='ssh -A waveaccounting@72.51.30.144'
alias vstbeat='ssh -A waveaccounting@72.51.30.23'
alias vstdb1='ssh -A waveaccounting@72.51.30.139'
alias vstdb2='ssh -A waveaccounting@72.51.30.140'
